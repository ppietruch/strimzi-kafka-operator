...
The Cluster Operator provides data encryption and authentication for both Apache Kafka and Apache Zookeeper via the SSL/TLS protocol.
This makes it possible to encrypt data transferred between Kafka brokers, Zookeeper nodes, and clients and Kafka brokers.
